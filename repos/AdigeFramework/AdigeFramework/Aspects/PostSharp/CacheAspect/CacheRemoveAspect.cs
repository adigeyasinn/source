using AdigeFramework.CrossCuttingConcerns.Caching;
...
namespace AdigeFramework.Aspects.PostSharp.CacheAspect
{
    [Serializable]
   public class CacheRemoveAspect:OnMethodBoundaryAspect
    {
        ...
        public CacheRemoveAspect(string pattern, Type cacheType = null)
        {
            _pattern = pattern;
            _cacheType = cacheType;
        }
